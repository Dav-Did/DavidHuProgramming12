...
public class Triangle extends TwoDShape implements Rotate{
    ...
    // Overrides toString method in com.davidh.module1_4.TwoDShape
    @Override
    public String toString() {
        return "Side 1: "+side1+" Side 2: "+side2+" Side 3: "+side3+" Angle: "+angle+" com.davidh.module1_4.Colour: "+getColor();
    }

    // com.davidh.module1_4.Rotate interface overriding
    @Override
