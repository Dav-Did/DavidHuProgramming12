...
public class Triangle extends TwoDShape implements Rotate{
    ...
    public void rotate90() {
        angle = angle + 90.0; //Change the angle by 90 degrees
    }

    @Override
    public void rotate180() {
        angle = angle + 180.0; //Change the angle by 180 degrees
    }

    @Override
    public void rotate(double angle) {
        this.angle = this.angle + angle; //Change the angle by the angle in the parameter
    }
}
